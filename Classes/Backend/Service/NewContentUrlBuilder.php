...
class NewContentUrlBuilder
{
    ...
    {
        if ($defVals !== null) {
            return $this->getNewContentEditUrl($context, $container, $columnNumber, -$recordUid, $defVals);
        }
    ...
    public function getNewContentUrlAtTopOfColumn(PageLayoutContext $context, Container $container, int $columnNumber, ?array $defVals): ?string
    {
        ...
        if ($defVals !== null) {
            return $this->getNewContentEditUrl($context, $container, $columnNumber, $newContentElementAtTopTarget, $defVals);
        }
        return $this->getNewContentWizardUrl($context, $container, $columnNumber, $newContentElementAtTopTarget);
    }

    protected function getNewContentEditUrl(PageLayoutContext $context, Container $container, int $columnNumber, int $uidPid, array $defVals): string
    {
